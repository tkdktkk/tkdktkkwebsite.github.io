...
<main>
  ...
  <div id="contents">
    ...
    <p>
      管理画面では、デフォルトの状態ではdata-iinename属性に設定したボタン名が、数字→アルファベット→日本語の昇順となり、いいねボタンが一覧になっています。<br>
      いいねボタンを見やすく並べ替えたい場合は、data-iinename属性につける名前を工夫してみて下さい。<br>
      例：トップページは「000-トップページ」、作品ページにつけるいいねボタンは「101-作品１」「102-作品２」など<br>
      また設定変更画面からいいねボタンを降順に並べるように設定することができます。
    </p>
